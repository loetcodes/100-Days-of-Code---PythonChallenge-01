...
Output Format:
  Print n lines where each line i (in the range 1 <= i <= n) contains the respective decimal, octal, capitalized hexadecimal, and binary values of n. 
...
def print_formatted(number):
  # Prints all the numbers from 1 to the number formatted to match the binary length of the number.
