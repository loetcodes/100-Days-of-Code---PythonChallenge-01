""" 
Day 10 - Exceptions String - HackerRank
...
constructs built into your submission language. If you attempt to use
loops/conditional statements, you will get a 0 score.
...
Constraints:
	...
	S is composed of either lowercase letters (a - z) or
	decimal digits (0 - 9). 

Output Format:
Print the parsed integer value of S, or Bad String if S cannot be
...
it to an integer will raise an exception. Thus, our exception handler
prints Bad String. 
